...
//             const img = await faceapi.fetchImage(`/face-ai/public/faces/${label}/${i}.jpg`);
...
//           } catch (err) {
//             console.warn("Image missing:", label, i, err);
//           }
//         }
